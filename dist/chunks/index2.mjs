...
import require$$8 from 'node:url';
...
function npmRunPath(options = {}) {
	const {
		cwd = process$1$1.cwd(),
		path: path_ = process$1$1.env[pathKey()],
		execPath = process$1$1.execPath,
	} = options;

	let previous;
	const execPathString = execPath instanceof URL ? require$$8.fileURLToPath(execPath) : execPath;
	const cwdString = cwd instanceof URL ? require$$8.fileURLToPath(cwd) : cwd;
...
function npmRunPathEnv({env = process$1$1.env, ...options} = {}) {
	env = {...env};
